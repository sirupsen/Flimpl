...
<p>Oh damn, I gotta go. Hopefully you learned a bit about me and my mom! Oh, and you can meet my <?php echo $other; ?> <a href="<?php echo $site_url; ?><?php echo $link; ?>">here.</a></p>
